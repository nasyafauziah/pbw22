...
<div class="row" style="margin: 30px 0px;">
    ...
    $editprofilestatus = $sess->get('editprofile');
    if($editprofilestatus == 'success'){
        echo '<div class="alert alert-warning" role="alert">
            Profile berhasil diubah.
            </div>';
    }
    if($editprofilestatus == 'error'){
        echo '<div class="alert alert-danger" role="alert">
            Kesalahan Edit Profile.
            </div>';
    }
    ?>
    ...
    <div class="card-body">
        ...
        <p>
        <a class="text-decoration-none text-dark" style="font-size: 1rem;" href="<?=base_url('/profile/edit//'.$user['userid'])?>">Edit Profile</a>
        </p>
        <p class="card-text">
